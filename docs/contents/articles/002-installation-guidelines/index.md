...
Although beauty-tips-admin can be run without any development experience, it would be much easier if you already have some. 
...
You will need to clone the source code of beauty-tips-admin GitHub repository:

```bash
git clone https://github.com/akveo/beauty-tips-admin.git
```
After the repository is cloned, go inside of the repository directory and install dependencies:

```bash
cd beauty-tips-admin
npm install
```
This will setup a working copy of beauty-tips-admin on your local machine.
